"""
Django settings for camelion2 project.
...
WSGI_APPLICATION = 'camelion2.wsgi.application'
...
IPINFO_API_ACCESS_TOKEN = os.environ.get('IPINFO_API_ACCESS_TOKEN')
